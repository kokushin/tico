...
var _listStyle = __webpack_require__(20);

var _margin = __webpack_require__(51);

var _overflow = __webpack_require__(52);
...
var _html2canvas = __webpack_require__(40);
...
exports.default = {
  ...
  data: function data() {
    return {
      ...
      size: [16, 32, 96, 114, 144, 180, 240, 500]
    };
  },
  ...
  methods: {
    getImageData: function getImageData() {
      ...
      var imageSize = 0;
      var data = [];
      var imageSizeLength = this.size.length;
      ...
      new Promise(function (resolve, reject) {
        for (var i = 0; i < imageSizeLength; i++) {
          ...
          (0, _html2canvas2.default)(document.querySelector('#preview'), {
            logging: false,
    ...
    sendImageData: function sendImageData(data) {
      var _this2 = this;

      _axios2.default.post('/download', {
        data: data
      }).then(function (res) {
        _this2.donwloadZipFile(res.data.link);
      }).catch(function (err) {
        console.log(err);
      });
    },
    donwloadZipFile: function donwloadZipFile(link) {
...
var _punycode = __webpack_require__(57);
...
var _Unicode = __webpack_require__(60);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(12), __webpack_require__(36).setImmediate))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_App_vue__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3ea74058_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_App_vue__ = __webpack_require__(85);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3ea74058_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bustCache_App_vue__["a" /* default */],
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(58)(module), __webpack_require__(12)))
...
var _Gradient = __webpack_require__(62);
...
var _Angle = __webpack_require__(63);
...
var _ResourceLoader = __webpack_require__(65);
...
var render = function() {
  ...
  return _c("div", { attrs: { id: "app" } }, [
    _c("link", {
      attrs: {
        href: "https://fonts.googleapis.com/css?family=" + _vm.font,
        rel: "stylesheet"
      }
    }),
    _vm._v(" "),
    ...
    _c("div", { staticClass: "main" }, [
      _c("div", { staticClass: "main_input" }, [
        _c("div", { staticClass: "option" }, [
          _c("div", { staticClass: "option_box" }, [
            _c(
              "label",
              { staticClass: "option_title", attrs: { for: "text" } },
              [_vm._v("Text:")]
            ),
            _vm._v(" "),
            _c("input", {
          ...
          _c("div", { staticClass: "option_box" }, [
            _c(
              "label",
              { staticClass: "option_title", attrs: { for: "scale_fontSize" } },
              [_vm._v("Text size:")]
            ),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.scale.fontSize,
                  expression: "scale.fontSize"
                }
              ],
              attrs: { type: "number", id: "scale_fontSize" },
              domProps: { value: _vm.scale.fontSize },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.scale, "fontSize", $event.target.value)
                }
              }
            })
          ]),
          ...
          _c("div", { staticClass: "option_box" }, [
            _c(
              "label",
              { staticClass: "option_title", attrs: { for: "scale_width" } },
              [_vm._v("Width:")]
            ),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.scale.width,
                  expression: "scale.width"
                }
              ],
              attrs: { type: "number", id: "scale_width" },
              domProps: { value: _vm.scale.width },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.scale, "width", $event.target.value)
                }
              }
            })
          ]),
          ...
          _c("div", { staticClass: "option_box" }, [
            _c(
              "label",
              { staticClass: "option_title", attrs: { for: "scale_height" } },
              [_vm._v("Height:")]
            ),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.scale.height,
                  expression: "scale.height"
                }
              ],
              attrs: { type: "number", id: "scale_height" },
              domProps: { value: _vm.scale.height },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.scale, "height", $event.target.value)
                }
              }
            })
          ]),
          ...
          _c("div", { staticClass: "option_box" }, [
            _c(
              "label",
              { staticClass: "option_title", attrs: { for: "font" } },
              [_vm._v("Font:")]
            ),
            _vm._v(" "),
            _c("input", {
          ...
          _vm._v(" "),
          _c("div", { staticClass: "option_box" }, [
            _c("span", { staticClass: "option_title" }, [_vm._v("Type:")]),
            _vm._v(" "),
            _c("label", { attrs: { for: "type_square" } }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
                ...
                attrs: { type: "radio", id: "type_square", value: "square" },
                domProps: { checked: _vm._q(_vm.type, "square") },
                on: {
            ...
            _c("label", { attrs: { for: "type_round" } }, [
              _c("input", {
                ...
                attrs: { type: "radio", id: "type_round", value: "round" },
                domProps: { checked: _vm._q(_vm.type, "round") },
                on: {
                  change: function($event) {
                    _vm.type = "round"
                  }
          ...
          _vm._v(" "),
          _c("div", { staticClass: "option_box" }, [
            _c("span", { staticClass: "option_title" }, [
              _vm._v("Text color:")
            ]),
            _vm._v(" "),
            _c("label", { attrs: { for: "text_color_black" } }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
                ...
                domProps: { checked: _vm._q(_vm.textColor, "black") },
                on: {
                  change: function($event) {
                    _vm.textColor = "black"
                  }
            ...
            _vm._v(" "),
            _c("label", { attrs: { for: "text_color_white" } }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
                ...
                domProps: { checked: _vm._q(_vm.textColor, "white") },
                on: {
                  change: function($event) {
                    _vm.textColor = "white"
                  }
          ...
          _c("div", { staticClass: "option_box" }, [
            ...
            _vm._v(" "),
            _c("label", { attrs: { for: "background_color_black" } }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
                ...
                domProps: { checked: _vm._q(_vm.backgroundColor, "black") },
                on: {
                  change: function($event) {
            ...
            _vm._v(" "),
            _c("label", { attrs: { for: "background_color_white" } }, [
              _c("input", {
                directives: [
                  {
                    name: "model",
                ...
                domProps: { checked: _vm._q(_vm.backgroundColor, "white") },
                on: {
                  change: function($event) {
        ...
        !_vm.download
          ? _c(
              "button",
              {
                staticClass: "main_input_button",
                on: { click: _vm.getImageData }
              },
              [_vm._v("Donwload")]
            )
          : _c(
              "button",
              { staticClass: "main_input_button", attrs: { disabled: "" } },
              [_vm._v("Generating...")]
            )
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "main_output" }, [
        _c("p", { staticClass: "main_output_title" }, [_vm._v("Preview: ")]),
        _vm._v(" "),
        _c("div", { staticClass: "main_output_canvas" }, [
          _c(
            "div",
            {
              staticClass: "preview",
            ...
            [
              _c(
                "div",
                {
                  staticClass: "preview_background",
                  style: {
                    width: _vm.scale.width + "px",
                    height: _vm.scale.height + "px"
                  },
                  attrs: { id: "preview-background" }
                },
                [
                  _c(
                    "div",
                    {
                      staticClass: "preview_text",
                      style: {
                        fontSize: _vm.scale.fontSize + "px",
                        fontFamily: _vm.font
                      },
                      attrs: { id: "preview-text" }
                    },
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("header", { staticClass: "header" }, [_c("h1", [_vm._v("tico")])])
  }
]
